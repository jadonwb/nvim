...
--- Animate a brief cursor "shake" by moving one step in a valid
--- direction, then restoring the original position after a short delay.
--- Returns a restore function, or nil if no valid move direction exists.
function NVCursor.shake()
  ...
  vim.wait(1000, function()
    ...
    return next_line ~= cur_line or next_col ~= cur_col
  end, 10, false)
