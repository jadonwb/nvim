...
function M.keymaps()
  vim.keymap.set('n', '<M-l>t', function()
    M.level = 'trace'
    M.info 'log level: trace'
  end, { desc = 'Log level: trace', silent = true })
  vim.keymap.set('n', '<M-l>d', function()
    M.level = 'debug'
    M.info 'log level: debug'
  end, { desc = 'Log level: debug', silent = true })
  vim.keymap.set('n', '<M-l>i', function()
    M.level = 'info'
    M.info 'log level: info'
  end, { desc = 'Log level: info', silent = true })
end
