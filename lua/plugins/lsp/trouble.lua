  ...
  opts = function()
    return {
      ...
      keys = {
        ...
        ['<cr>'] = 'jump_close',
        ['<S-CR>'] = 'jump',
        [NVKeymaps.open_hsplit] = 'jump_split_close',
        [NVKeymaps.open_vsplit] = 'jump_vsplit_close',
        --   ['<Right>'] = 'fold_open',
        --   ['<A-Right>'] = 'fold_open_recursive',
        --   ['<Left>'] = 'fold_close',
        --   ['<A-Left>'] = 'fold_close_recursive',
        --   ['<Space>'] = 'fold_toggle',
        --   ['<A-Space>'] = 'fold_toggle_recursive',
      },
    }
  end,
